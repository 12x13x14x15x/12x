...
for xd in range(10000):
	...
	uaku=f'Mozilla/5.0 (Linux; U; Android 5.1; iris605 Build/LMY47I; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/46.0.2490.76 Mobile Safari/537.36 OPR/42.0.2254.139276'
	ugen2.append(uaku)

for t in range(10000):
	rr = random.randint
	brayen1=f'Mozilla/5.0 (Linux; Android 6.0.1; S60 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.87 Mobile Safari/537.36 Maxthon/3241'
	brayen2=f'Mozilla/5.0 (Linux; Android 7.1.1; SHV39 Build/S6079) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/72.0.3626.76 Mobile Safari/537.36 Maxthon/3241'
	brayen3=f'Mozilla/5.0 (Linux; Android 4.4.2; S400 Build/KOT49H) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/30.0.0.0 Safari/537.36 Maxthon/3241'
	brayen4=f'Mozilla/5.0 (Linux; Android 6.0.1; S60 Build/MMB29M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/78.0.3904.108 Mobile Safari/537.36 Maxthon/3241'
...
for x in range(10):
	...
	d=random.randrange(4200,4900)
	e=random.randrange(40,150)
	uak=f'Mozilla/5.0 (Linux; Android 7.0; S60 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/51.0.2704.91 Mobile Safari/537.36 Maxthon/3241'
def uaku():
	try:
